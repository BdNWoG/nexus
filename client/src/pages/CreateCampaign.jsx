  ...
  return (
    <div className='bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4'>
      ...
      <form onSubmit={handleSubmit} className='w-full mt-[65px] flex flex-col gap-[30px] '>
        ...
        <FormField labelName="Story *" placeholder="Write your Story" isTextArea={true} value={form.description} handleChange={(e) => handleFormFieldChange('description', e)}/>
        <div className='w-full flex justify-start items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]'>
          <img src={money} alt="money" className="w-[40px] h-[40px] object-contain" />
          <h4 className='font-epilogue font-bold text-[25px] text-white ml-[2 0px]'>
        ...
        <FormField labelName="Campaign Image *" placeholder="Image URL of your campaign" inputType="url" value={form.image} handleChange={(e) => handleFormFieldChange('image', e)}/>
